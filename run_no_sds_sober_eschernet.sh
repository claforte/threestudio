# exp_name0=WildnFree_noBG_stable_eschernet
# exp_name=WildnFree_noBG_stable_eschernet_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_WildnFree_noBG_stable/EscherNet/"
# # mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/EscherNet"

# for dir in /weka/proj-sv3d/EVAL_WildnFree_noBG_stable/EscherNet/*/; \
# do (
#     OBJ=$(basename -- $dir)
...
#     trainer.max_steps=800 data.train_downsample_resolution=2 data.full_resolution_step=1000 \
#     data.use_omnidata_normals=False system.loss.lambda_normal=0.0 && \
#     # data.omnidata_normal_path=$mono_normal_dir/$OBJ/ && \
...
# exp_name0=WildnFree_STUDY_eschernet
# exp_name=WildnFree_STUDY_eschernet_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_WildnFree_STUDY/EscherNet/"
# # mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/EscherNet"

# for dir in /weka/proj-sv3d/EVAL_WildnFree_STUDY/EscherNet/*/; \
# do (
#     OBJ=$(basename -- $dir)
#     python launch.py --train --config=$config0 name=$exp_name0 tag=$OBJ \
#     data.sober_or_drunk=$sober_or_drunk data.dataroot=$data_root/$OBJ/ \
...
exp_name0=OmniObject3D_eschernet
exp_name=OmniObject3D_eschernet_refine
config0=configs/kplanes_no_sds_mark.yaml
config=configs/kplanes_no_sds_refine_mark.yaml
sober_or_drunk=sober
data_root="/weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/EscherNet/"
# mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/EscherNet"

for dir in /weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/EscherNet/*/; \
do (
    OBJ=$(basename -- $dir)
    python launch.py --train --config=$config0 name=$exp_name0 tag=$OBJ \
    data.sober_or_drunk=$sober_or_drunk data.dataroot=$data_root/$OBJ/ \
...
# exp_name0=GSO_eschernet_static_static_no_sds
# exp_name=GSO_eschernet_static_static_no_sds_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_GSO300/GSO_sober21/EscherNet/"
# mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/EscherNet"
