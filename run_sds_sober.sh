...
exp_name0=GSO_sv3d-p_static_static_sds
exp_name=GSO_sv3d-p_static_static_sds_refine
config0=configs/kplanes_no_sds_mark.yaml
config=configs/kplanes_sds_refine_mark.yaml
sober_or_drunk=sober
data_root="/weka/home-chunhanyao/sv3d_eval/MODEL_sv3d-uncond-to-cond_IMG_static_ORBIT_static"
mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/MODEL_sv3d-uncond-to-cond_IMG_static_ORBIT_static"
