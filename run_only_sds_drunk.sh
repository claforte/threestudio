...
exp_name0=GSO_hashgrid_drunk_only_sds
exp_name=GSO_hashgrid_drunk_sds_only_refine
config0=configs/kplanes_only_sds_mark.yaml
config=configs/kplanes_only_sds_refine_mark.yaml
