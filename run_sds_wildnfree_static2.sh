...
exp_name0=WildnFree_STUDY_static
exp_name=WildnFree_STUDY_static_refine
config0=configs/kplanes_no_sds_mark.yaml
config=configs/kplanes_sds_refine_mark.yaml
sober_or_drunk=sober
data_root="/weka/home-chunhanyao/sv3d_eval/EVAL_WildnFree_STUDY_static/"
mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/EVAL_WildnFree_STUDY_static/"
