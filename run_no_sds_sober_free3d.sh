# exp_name0=WildnFree_noBG_stable_Free3D
# exp_name=WildnFree_noBG_stable_Free3D_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_WildnFree_noBG_stable/Free3D/"
# # mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/Free3D"

# for dir in /weka/proj-sv3d/EVAL_WildnFree_noBG_stable/Free3D/*/; \
# do (
#     OBJ=$(basename -- $dir)
...
# exp_name0=WildnFree_STUDY_Free3D
# exp_name=WildnFree_STUDY_Free3D_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_WildnFree_STUDY/Free3D/"
# # mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/Free3D"

# for dir in /weka/proj-sv3d/EVAL_WildnFree_STUDY/Free3D/*/; \
# do (
#     OBJ=$(basename -- $dir)
#     python launch.py --train --config=$config0 name=$exp_name0 tag=$OBJ \
#     data.sober_or_drunk=$sober_or_drunk data.dataroot=$data_root/$OBJ/ \
...
exp_name0=OmniObject3D_Free3D
exp_name=OmniObject3D_Free3D_refine
config0=configs/kplanes_no_sds_mark.yaml
config=configs/kplanes_no_sds_refine_mark.yaml
sober_or_drunk=sober
data_root="/weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/Free3D/"
# mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/Free3D"

for dir in /weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/Free3D/*/; \
do (
    OBJ=$(basename -- $dir)
    python launch.py --train --config=$config0 name=$exp_name0 tag=$OBJ \
    data.sober_or_drunk=$sober_or_drunk data.dataroot=$data_root/$OBJ/ \
...
# exp_name0=GSO_Free3D_static_static_no_sds
# exp_name=GSO_Free3D_static_static_no_sds_refine
# config0=configs/kplanes_no_sds_mark.yaml
# config=configs/kplanes_no_sds_refine_mark.yaml
# sober_or_drunk=sober
# data_root="/weka/proj-sv3d/EVAL_GSO300/GSO_sober21/Free3D/"
# mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/Free3D"
