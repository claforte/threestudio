...
exp_name0=OmniObject3D_sober
exp_name=OmniObject3D_sober_refine
config0=configs/kplanes_no_sds_mark.yaml
config=configs/kplanes_sds_refine_mark.yaml
sober_or_drunk=sober
data_root="/weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/SV3D_uncond_to_cond/"
mono_normal_dir="/weka/home-chunhanyao/sv3d_eval/OmniObject3D_sober21/"
svd_model="prediction_3D_OBJ_SVD21V_drunk"

for dir in /weka/proj-sv3d/EVAL_OmniObject3D/OmniObject3D_sober21/SV3D_uncond_to_cond/c*/
do (
    OBJ=$(basename -- $dir)
    ...
    data.random_camera.cond_img_path=/weka/proj-sv3d/DATASETS/OmniObject3D_sober21/$OBJ/ \
    data.omnidata_normal_path=$mono_normal_dir/$OBJ/ \
